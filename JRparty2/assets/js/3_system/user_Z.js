      ...
      'bootstrap-datetimepicker', 'bootstrap-datetimepicker.zh-CN'], function ($) {
          ...
          $.ajax({
              ...
              success: function (data) { 
                  ...
                  $remove = $('#table-remove'),
                  selections = [];
                  // $table.attr("data-url", "/JRPartyService/System.svc/getUserList?districtID=" + $.cookie('JTZH_districtID') + "&");
                  function initTable() {
                  ...
                  function operateFormatter(value, row, index) {
                      if (row.district == $.cookie('JTZH_districtID')) {
                          return [ 
                          ...
                          return [ 
                                    '<a class="am-btn"  style="color:#eee"    title="编辑" >',
                                    '<i class="glyphicon glyphicon-edit"></i>编辑',
                                    '</a>', 
                          ].join('');
                      } 
                          ...
                          $.ajax({
                              ...
                              success: function (data) { 
                                  ...
                                  var str = '<div class="form-group">' +
                                      '<label for="table_add_modal-name">所属组织</label>' +
                                    '<select id="table_add_modal-districtID" class="form-control"disabled title="部门"> ' + organ + '</select>' +
                                     '</div>' +
                                     '<div class="form-group">' +
                                      '<label for="table_add_modal-name">用户名称</label>' +
                                    '<input type="text" class="form-control" id="table_add_modal-name"disabled placeholder="请输入用户角色">' +
                                    '</div>' +
                                     '<div class="form-group">' +
                                     '<label for="#table_add_modal-phone">手机号(为保证接收推送消息，请及时补全)</label>' +
                                    '<input type="text" class="form-control" id="table_add_modal-phone" placeholder=" 请输入手机号">' +
                                    '</div>' +
                                     '<div class="form-group">' +
                                  ...
                                  $("#table_add_modal-districtID").val(row.attachDistrict);
