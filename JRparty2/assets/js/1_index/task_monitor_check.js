    ...
    'bootstrap-datetimepicker', 'bootstrap-datetimepicker.zh-CN'], function ($) {
        ...
        function operateFormatter(value, row, index) {
            return [    '<a class="exam am-btn"style="color:#337ab7" href="javascript:void(0)" title="审核">',
                       ...
                       '<a class="check am-btn"  style="color:#337ab7" href="javascript:void(0)"  title="监控截屏" >',
                        ...
                        '<i class="glyphicon glyphicon-search"></i>手机摄屏&nbsp;&nbsp;&nbsp;',
                        '</a>',  
            ].join('');
        }
        ...
        window.operateEvents = {
            ...
            'click .appCheck': function (e, value, row, index) {
                $.ajax({
                    type: "GET",
                    url: svc_sys + "/getActivityByPolitic",
                    data: {
                        districtID: row.id,
                    },
                    success: function (data) {//成功后需要刷新一下？前台已经删了，不用刷新的
                        ...
                        for (var i in data.rows) {
                            ...
                            $('#common-jiyao .modal-body').append('<div class="row"><div class="html-peek-image col-xs-6 col-md-3"><a href="' + 'http://172.16.0.221:8006/JRPartyService/Upload/' + data.rows[i].URL + '" target="_blank" class="thumbnail"><img src="' + 'http://172.16.0.221:8006/JRPartyService/Upload/' + data.rows[i].URL + '" alt="' + 'http://172.16.0.221:8006/JRPartyService/Upload/' + data.rows[i].URL + '"width="100" height="84"></a></div></div>');
                ...
                //$('#common-jiyao .modal-title').html('');
                //$('#common-jiyao .modal-title').html('提示');
                //$('#common-jiyao .modal-body').html('');
                //$('#common-jiyao .modal-body').html('<h2><i class="glyphicon glyphicon-menu-right"></i>王元</h2>');
                //$('#common-jiyao .modal-body').append('<p class="lead">' + '第一次党员大会顺利召开' + '</p>');
                //$('#common-jiyao .modal-body').append('<div class="row"><div class="html-peek-image col-xs-6 col-md-3"></div></div>');
                //$('#common-jiyao .modal-body .html-peek-image').append('<a href="../assets/img/' + 'bg2.jpg' + '" target="_blank" class="thumbnail"><img src="../assets/img/' + 'bg2.jpg' + '" alt="../assets/img/' + 'bg2.jpg' + '"width="100" height="84"></a>');
                //$('#common-jiyao').modal();
