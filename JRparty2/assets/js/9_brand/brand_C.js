...
require(['jquery', 'jquery.cookie', 'bootstrap', 'bootstrap-table', 'bootstrap-select',
    'bootstrap-datetimepicker', 'bootstrap-datetimepicker.zh-CN', "fileinput", "fileinput_locale_zh" ,'print'], function ($) {
        accountCheck();
        var $table = $('#table'),
        $remove = $('#table-remove'),
        selections = [];
        ...
        function initTable() {
            $table.bootstrapTable({
                ...
                onLoadSuccess: function () {
                    ...
                    var columnName2 = "town";
                    mergeTable(columnName2);
        ...
        window.operateEvents = {
            ...
            'click .grade': function (e, value, row, index) {
                ...
                $("#table_grade_modal .modal-body").html('<div class="form-group">' +
                                                       '<label for="brand">等级：</label>' +
                                                       '<select id="table_grade_modal-rate" class="form-control selectpicker" title="等级"> ' +
                            ...
                            success: function (data) {
                                ...
                                var str = '<form id="editform">' +
                                            '<div class="form-group">' +
                                                ...
                                                '<select id="table_edit_modal-districtID"  name="districtID" class="form-control selectpicker" title="所属组织"> ' + organ + '</select>' +
                                                 '</div>' +
                                                  '<div class="form-group">' +
                                                    '<label for="table_edit_modal-title">名称</label>' +
                                                    ...
                                                    '<input type="text" name="id"hidden id="table_add_modal-id" >' +
                                            '</div>' +
                                           '<div class="form-group">' +
                                ...
                                console.log(data.data.districtID);
        ...
        $("#ele2").on('click', function () {
            ...
            $("#table").print({
                ...
                mediaPrint: false,
                //Custom stylesheet
                stylesheet: "../assets/css/bootstrap-table.css",
