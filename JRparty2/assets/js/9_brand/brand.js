    ...
    'bootstrap-datetimepicker', 'bootstrap-datetimepicker.zh-CN', "fileinput", "fileinput_locale_zh"], function ($) {
        ...
        function operateFormatter(value, row, index) {
            return [
                        ...
                        '<i class="glyphicon glyphicon-check"></i>附件',
                        '</a> ',
        ...
        window.operateEvents = {
            ...
            'click .check': function (e, value, row, index) {
                ...
                $.ajax({
                   url: svc_brand + "/getSBFiles?",    //后台webservice里的方法名称
                   data: {
                       id: row.id
                   },
                   type: "get",
                   success: function (data) {
                       ...
                       for (var i in data.data) {
                           ...
                           //str = str + '<a style="line-height:2.5" href="' + data.data + '"><img src="../assets/img/file.png" />' + fileName + '</a>&nbsp;&nbsp;&nbsp;<a href="#"style="line-height:2.5"><img src="../assets/img/1_index/remove.png"onclick="delet(\'' + data.data.imageURL[i].id + '\')"width="20" style="margin-top:7px" /></a></div><br>'
                           str = str + '<a style="line-height:2.5" href="' + data.data + '"><img src="../assets/img/file.png" />' + fileName + '</a>&nbsp;&nbsp;&nbsp;</div><br>'
                       }
            ...
            'click .remove': function (e, value, row, index) {
                ...
                $(".confirm").click(function () {
                    ...
                    $.ajax({
                        type: "GET",
                        url: svc_brand + "/deleteBrand",//http://172.16.0.221:8006/JRPartyService/Party.svc/deletePlan?id={id}
                        data: {
                            id: row.id
                        },
