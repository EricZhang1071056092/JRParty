                    ...
                    onPageChange: function (num, type) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (data.data[0] != null) {
                                    for (var i in data.data) {
                                        $("#baguetteBox_image").append('<span id="' + i + '" style="margin-left:20px;margin-top:5px"><a href="' + 'http://172.16.0.221:8006/JRPartyService/picture/' + data.data[i] + '" id="' + i + '"><img src="' + 'http://172.16.0.221:8006/JRPartyService/picture/' + data.data[i] + '" width="220"style="margin-top:30px"/></a></span>');
                                    }
                                    $(".srcId").css({ "position": "absolute", "float": "right", "margin-left": "-20px", "z-index": "99", "width": "20", "height": "20" });
                                    baguetteBox.run('.baguetteBoxOne', {
                                        // Custom options
