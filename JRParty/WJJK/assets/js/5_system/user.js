require(['jquery', 'jquery.cookie', 'bootstrap', 'bootstrap-table'], function ($) {

    var $table = $('#table'),
    $remove = $('#table-remove'),
    selections = [];
    //$table.attr("data-url", "/JRPartyService/Party.svc/getUserList?districtID=" + $.cookie('JTZH_districtID') + "&");
    var data1 = [
   ...
   },
   {
    ...
    $(function () {
        var scripts = [
                '../assets/js/common/bootstrap-table.js',
                '../assets/js/common/bootstrap-table-export.js',
                '../assets/js/common/tableExport.js',
        ],
