...
require(['jquery', 'jquery.cookie', 'bootstrap', 'bootstrap-table', 'bootstrap-select',
    'bootstrap-datetimepicker', 'bootstrap-datetimepicker.zh-CN', 'qrcode'], function ($) {
        ...
        $remove = $('#table-remove'),
        selections = [];
        $table.attr("data-url", "/JRPartyService/Party.svc/getPoliticList?districtID=" + $.cookie('JTZH_districtID') + "&");
        ...
        $('#table-add').click(function () { 
            ...
            var str = '<div class="form-group">' +
                      ...
                      '</div>' +
                       '<div class="form-group">' +
                          '<label for="table_add_modal-IDCard">身份证</label>' +
                          '<input type="text" class="form-control" id="table_add_modal-IDCard" placeholder="请填写性别">' +
                      '</div>' +
                       '<div class="form-group">' +
                          '<label for="table_add_modal-phone">联系方式</label>' +
                          '<input type="text" class="form-control" id="table_add_modal-phone" placeholder="请填写性别">' +
                      '</div>' +
                       '<div class="form-group">' +
                          '<label for="table_add_modal-name">性别</label>' +
            ...
            '<div class="form-group">' +
                          '<label for="table_add_modal-nation">民族</label>' +
                          '<input type="text" class="form-control" id="table_add_modal-nation" placeholder="请填写性别">' +
                      '</div>' +
            '<div class="form-group">' +
                         '<label for="table_add_modal-workPlace">工作地点</label>' +
                         '<input type="text" class="form-control" id="table_add_modal-workPlace" placeholder="请填写入党时间">' +
                     '</div>' +
                      '<div class="form-group">' +
                         '<label for="table_add_modal-educationDegree">学历</label>' +
                         '<input type="text" class="form-control" id="table_add_modal-educationDegree" placeholder="请填写入党时间">' +
                     '</div>'
